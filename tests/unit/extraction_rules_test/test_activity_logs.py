...
administrative_expected_output = {
    ...
    "dt.source_entity": "['AZURE_STORAGE_ACCOUNT-A5A9F4A68D9B0D44', 'CUSTOM_DEVICE-A5A9F4A68D9B0D44']",
    "dt.entity.custom_device": "CUSTOM_DEVICE-A5A9F4A68D9B0D44",
...
resource_health_expected_output = {
    ...
    "dt.source_entity": "['AZURE_LOAD_BALANCER-0C3A32CD8FA39936', 'CUSTOM_DEVICE-0C3A32CD8FA39936']",
    "dt.entity.custom_device": "CUSTOM_DEVICE-0C3A32CD8FA39936",
